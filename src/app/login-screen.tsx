      ...
      <div className="auth-card">
        <div className="auth-side">
          ...
          <div className="auth-hint">
            Première utilisation : créez votre compte avec un identifiant, un mot de passe et votre fonction. Les droits d&rsquo;administration sont attribués séparément par un administrateur, jamais lors de la création du compte.
          </div>
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          {mode === "signup" && (
            <label className="auth-field">
              <span>Fonction</span>
              <input type="text" placeholder="Ex : Réceptionniste, Mécanicien…" value={role} onChange={(event) => setRole(event.target.value)} />
            </label>
          )}
